...
export const EXPENSE_CATEGORIES: CategoryWithTemplates[] = [
  ...
  },
  {
    ...
    sub_category_templates: [
      ...
      { id: 'electricity', category_id: 'fixed', name: 'Electricity', icon: '⚡', is_default_selected: true, display_order: 2 },
      { id: 'water', category_id: 'fixed', name: 'Water', icon: '💧', is_default_selected: false, display_order: 3 },
      { id: 'gas', category_id: 'fixed', name: 'Gas', icon: '🔥', is_default_selected: false, display_order: 4 },
      { id: 'internet', category_id: 'fixed', name: 'Internet', icon: '📶', is_default_selected: true, display_order: 5 },
      { id: 'phone-bill', category_id: 'fixed', name: 'Phone Bill', icon: '📱', is_default_selected: true, display_order: 6 },
      { id: 'maid-help', category_id: 'fixed', name: 'Maid/Help', icon: '🧹', is_default_selected: false, display_order: 7 },
      { id: 'society-maintenance', category_id: 'fixed', name: 'Society Maintenance', icon: '🏢', is_default_selected: false, display_order: 8 },
      { id: 'subscriptions', category_id: 'fixed', name: 'Subscriptions', icon: '📺', is_default_selected: false, display_order: 9 },
    ],
  },
  {
    id: 'variable',
    ...
    sub_category_templates: [
      ...
      { id: 'fuel', category_id: 'variable', name: 'Fuel', icon: '⛽', is_default_selected: false, display_order: 2 },
      { id: 'food-ordering', category_id: 'variable', name: 'Food Ordering', icon: '🍕', is_default_selected: true, display_order: 3 },
      { id: 'dining-out', category_id: 'variable', name: 'Dining Out', icon: '🍽️', is_default_selected: false, display_order: 4 },
      { id: 'shopping', category_id: 'variable', name: 'Shopping', icon: '🛍️', is_default_selected: false, display_order: 5 },
      { id: 'entertainment', category_id: 'variable', name: 'Entertainment', icon: '🎬', is_default_selected: false, display_order: 6 },
      { id: 'personal-care', category_id: 'variable', name: 'Personal Care', icon: '💅', is_default_selected: false, display_order: 7 },
      { id: 'medical', category_id: 'variable', name: 'Medical', icon: '💊', is_default_selected: false, display_order: 8 },
      { id: 'transport', category_id: 'variable', name: 'Transport', icon: '🚌', is_default_selected: false, display_order: 9 },
      { id: 'miscellaneous', category_id: 'variable', name: 'Miscellaneous', icon: '📦', is_default_selected: true, display_order: 10 },
    ],
  },
  {
    id: 'one-time',
