...
function UploadStep({
  ...
  return (
    <div className="p-6">
      ...
      {/* Trust reassurance */}
      <div className="flex items-center justify-center gap-1.5 mt-4 px-2">
        ...
        <span className="text-[11px] text-gray-500">Your file is processed on this device. We do not store any sensitive information.</span>
      </div>
